...
LOG_DIR="$PROJECT_DIR/PAMPRO_PROC/_logs"
ANOM_DIR="$PROJECT_DIR/_anomalies"
HDF5_DIR="$PROJECT_DIR/PAMPRO_PROC/_hdf5"
CONF_DIR="$PROJECT_DIR/PAMPRO_PROC/_config"
RES_DIR="$PROJECT_DIR/_results"
PLOT_DIR="$PROJECT_DIR/_plots"
STIL_DIR="$PROJECT_DIR/PAMPRO_PROC/_stillbouts"
